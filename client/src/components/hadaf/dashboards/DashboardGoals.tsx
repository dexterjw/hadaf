...
interface HafizDashboardThirteenProps {
    settings: UserSettings;
    stats: CompletionData;
}

const HafizDashboardThirteen: React.FC<HafizDashboardThirteenProps> = ({ settings, stats }) => {
    return (
...
export default HafizDashboardThirteen;
