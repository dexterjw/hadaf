...
// Main dashboard items - numbered D1 through D9
const menuItems = [
    { id: 'dashboard' as HafizTab, label: 'D1 (Original)', icon: LayoutDashboard },
    { id: 'dashboard-1' as HafizTab, label: 'D2 (Gauge)', icon: Gauge },
    { id: 'dashboard-4' as HafizTab, label: 'D3', icon: LayoutDashboard },
    { id: 'dashboard-4-v1' as HafizTab, label: 'D4', icon: LayoutDashboard },
    { id: 'dashboard-4-v2' as HafizTab, label: 'D5', icon: LayoutDashboard },
    { id: 'dashboard-4-v3' as HafizTab, label: 'D6', icon: LayoutDashboard },
    { id: 'dashboard-5' as HafizTab, label: 'D7 (List)', icon: List },
    { id: 'dashboard-6' as HafizTab, label: 'D8 (Bento)', icon: Grid },
    { id: 'dashboard-7-gpt' as HafizTab, label: 'D9 (GPT)', icon: Sparkles },
    { id: 'dashboard-healthy-heart' as HafizTab, label: 'D10 (Health)', icon: Heart },
    { id: 'dashboard-13' as HafizTab, label: 'D13 (Goals)', icon: TrendingUp },
    { id: 'journey-roadmap' as HafizTab, label: 'D11 (Roadmap)', icon: Layers },
    { id: 'analytics' as HafizTab, label: 'D12 (Analytics)', icon: TrendingUp },
];
