...
import { FinishDateHero } from "@/features/prototype1/components/sections/FinishDateHero";
import { TimelineViz } from "@/features/prototype1/components/charts/TimelineViz";
import { ModeSwitcher } from "@/features/prototype1/components/features/ModeSwitcher";
import { DailyActionCard } from "@/features/prototype1/components/cards/DailyActionCard";
import { RealityPanel } from "@/features/prototype1/components/cards/RealityPanel";
import { motion, AnimatePresence } from "framer-motion";

import { ProgressDeficitChart } from "@/features/prototype1/components/charts/ProgressDeficitChart";
import { ProgressSurplusChart } from "@/features/prototype1/components/charts/ProgressSurplusChart";
import { JourneyMap } from "@/features/prototype1/components/sections/JourneyMap";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center px-4 pt-8 pb-20 overflow-hidden relative selection:bg-accent/30">
      ...
      <div className="absolute top-4 right-4 z-50 flex gap-2">
        <Link href="/labs/p1/log">
          <Button variant="ghost" size="sm" className="gap-2 text-muted-foreground hover:text-foreground">
            <PenTool className="w-4 h-4" />
            Log Progress
          </Button>
        </Link>
        <Link href="/labs/p1/dashboard">
          <Button variant="ghost" size="sm" className="gap-2 text-muted-foreground hover:text-foreground">
